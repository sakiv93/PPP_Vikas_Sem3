...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{Processing.png} 
...
\begin{figure}[H]
	...
	\begin{minipage}{.5\textwidth}
		...
		\captionof{figure}{CPE4 Element:U1 \\Abaqus generated result}
		\label{M1U1}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{M1U1_IGA.png}
		\captionof{figure}{IGA Element:U1 \\ Program generated result}
		\label{M1U1_IGA}
	\end{minipage}
\end{figure}
\begin{comment}
...
%\cite{agrawal2019iga} \cite{piegl2012nurbs}
